...
mkdir -p $DEST/db
cp -f /media/andrew/OCZ/source2026/optasql/db/summary.*.db $DEST/db/
#cp -f /media/andrew/OCZ/source2023/just-js/optasql/summary.*.db $DEST/db/
#cp -f /media/andrew/OCZ/source2023/just-js/optasql/summary.*.db ./db
#cp db/*.db $DEST/db/
